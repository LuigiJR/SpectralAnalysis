...
filename_insat3d = function(path2data,DateTime) {
        ...
        stem  = paste0('3DIMG_',DD,MON,YYYY,'_')
...
get60min_acc_insat3d = function(path2data,ValidDateTime){
###  INSAT data
        vROWS = 58:2760
        vCOLS = 48:2758
	proj = '+proj=geos +lon_0=82.0 +h=36000000  +datum=WGS84'
        Emn = -5438832; Emx = 5438829; Nmn = -5420807; Nmx=5420807

	vdatetime1 = ValidDateTime - 60 * 60  # 60 min previous
	vdatetime2 = ValidDateTime - 30 * 60  # 30 min previous

	f1  = filename_insat3d(path2data,vdatetime1)
	f2  = filename_insat3d(path2data,vdatetime2)
