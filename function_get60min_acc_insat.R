...
filename_insat = function(path2data,DateTime) {
...
get60min_acc_insat = function(path2data,ValidDateTime){
###  INSAT data
        vROWS = 58:2760
        vCOLS = 48:2758
	proj = '+proj=geos +lon_0=82.0 +h=36000000  +datum=WGS84'
        Emn = -5435511; Emx = 5435501; Nmn = -5419617; Nmx = 5419617

	vdatetime1 = ValidDateTime - 60 * 60  # 60 min previous
	vdatetime2 = ValidDateTime - 30 * 60  # 30 min previous

	f1  = filename_insat(path2data,vdatetime1)
	f2  = filename_insat(path2data,vdatetime2)
